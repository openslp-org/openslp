...
%WIX_PATH%\candle -nologo -dVERSION=%version% -dREVISION=%revision% openslp.wxs
%WIX_PATH%\light -nologo -out %package%_%version%_%revision%_%machine%.msi openslp.wixobj -ext WixUIExtension -cultures:en-us -sval
